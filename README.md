...
All simulated USA parameters were taken from system CAD models.

UCA array simulations were also taken into account for this program's design, which can be found at:

https://github.com/SL-UAV-MQP/MATLAB_Antenna_Element_And_Array_Simulation
